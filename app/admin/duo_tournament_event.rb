ActiveAdmin.register DuoTournamentEvent do
  ...
  member_action :convert_to_tournament_event do
    tournament_event = resource.convert_to_tournament_event
    if tournament_event
      redirect_to [:admin, tournament_event], notice: 'Conversion effectuée'
    else
